...
public class Contest extends BaseEntity{
    ...
    public Contest(String name, List<Question> questions, Level level, User creator,
            ContestStatus contestStatus) {
        this.name = name;
        // this.questions = new ArrayList<>(); failing due to this because it is initializing a new list
    ...
    private void validateQuestionList(List<Question> qList, Level contestLevel) throws InvalidContestException {
        ...
        // Level expectedLevel = qList.get(0).getLevel();

        // for(Question q: qList)
        // {
        //     Level actualLevel = q.getLevel();
        //     if(actualLevel!=expectedLevel || actualLevel!=contestLevel)
        //     {
        //         flag = false;
        //     }
        //     if(!flag)
